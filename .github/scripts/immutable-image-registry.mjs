...
const CANONICAL_SOURCE = 'https://github.com/DevPathAi/devpath-notification-svc';
const CANONICAL_REPOSITORY = 'DevPathAi/devpath-notification-svc';
const CANONICAL_IMAGE = 'ghcr.io/devpathai/devpath-notification-svc';
